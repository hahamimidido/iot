$(function() {
    //圖表變數
    var _Color = ['#0570c2', '#0c9ee7', '#23c4f9', '#F49F0A', '#03cdc2', '#16aec4', '#06e7e4', '#f6c21d'];
    // Create the chart
    ...
    Highcharts.chart('piefill', {
        ...
        series: [{
            name: 'Share',
            data: [{ name: 'Chrome', y: 61.41 }, { name: 'Internet Explorer', y: 11.84 }, { name: 'Firefox', y: 10.85 }, { name: 'Edge', y: 4.67 }, { name: 'Safari', y: 4.18 }, { name: 'Other', y: 7.05 }]
        }]
    });
    // boxplot 箱形圖
    ...
    function renderIcons() {
        ...
        if (!this.series[1].icon) {
            this.series[1].icon = this.renderer.path(
                ['M', -8, 0, 'L', 8, 0, 'M', 0, -8, 'L', 8, 0, 0, 8, 'M', 8, -8, 'L', 16, 0, 8, 8]).attr({
                stroke: '#ffffff',
                'stroke-linecap': 'round',
                'stroke-linejoin': 'round',
                'stroke-width': 2,
